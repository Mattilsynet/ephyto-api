...
dependencies {
    ...
    // mattilsynet
    implementation(platform("no.mattilsynet.fisk.libs:virtual-nats-bom:2025.05.15-13.50-c43f7c0128cb"))
    ...
    // protobuf
    implementation(platform("com.google.protobuf:protobuf-bom:4.31.0"))
    implementation("com.google.protobuf:protobuf-java")

    // gcp
    implementation(platform("org.springframework.cloud:spring-cloud-dependencies:2024.0.1"))
    implementation(platform("com.google.cloud:spring-cloud-gcp-dependencies:6.2.0"))
