...
dependencies {
    ...
    // mattilsynet
    implementation(platform("no.mattilsynet.fisk.libs:virtual-nats-bom:2025.06.24-15.17-bf63e34bc170"))
    ...
    // gcp
    implementation(platform("com.google.cloud:spring-cloud-gcp-dependencies:6.2.3"))
