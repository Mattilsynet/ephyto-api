...
dependencies {
    ...
    // mattilsynet
    implementation(platform("no.mattilsynet.fisk.libs:virtual-nats-bom:2025.09.23-14.33-227cbebe47e5"))
    ...
    // gcp
    implementation(platform("com.google.cloud:spring-cloud-gcp-dependencies:7.3.1"))
