...
dependencies {
    ...
    // mattilsynet
    implementation(platform("no.mattilsynet.fisk.libs:virtual-nats-bom:2025.02.24-12.58-eee8207abfbe"))
    ...
    implementation(platform("com.google.cloud:spring-cloud-gcp-dependencies:6.1.0"))
